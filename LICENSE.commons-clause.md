...
- You may **not** offer Enma (or a derivative whose value derives
  substantially from Enma) as a paid product or paid hosted/managed
  service to third parties without a commercial licence from the
  Licensor.
- Bundling Enma into a larger product whose paid value clearly
  derives from other components is permitted, as long as the Enma
  portion itself is not the substantial source of paid value.

If you want to sell Enma as a service or product, contact the
